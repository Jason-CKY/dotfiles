...
4. **Search check:** For each architectural pattern, infrastructure component, or concurrency approach the plan introduces:
   ...
   Note: WebSearch is not available in this environment. Skip this check and note: "Search unavailable — proceeding with in-distribution knowledge only."
...
## Outside Voice — Not Available

Note: Codex and subagent dispatch are not available in this environment. Skip this step and continue to outputs.

**Cross-model tension:**

(N/A — outside voice not available)
...
Analyze the plan's implementation steps for parallel execution opportunities. This helps the user split work across git worktrees or parallel execution.
...
- Outside voice: skipped (not available)
...
After completing all review sections, state "All review sections complete."
