...
cp -r ~/.claude/skills/repo-init/bundled/auto-learn/. .claude/skills/auto-learn/
...
`~/.claude/skills/repo-init/bundled/auto-learn/SKILL.md`

### rules
Manages the rule lifecycle with automatic conflict detection. Bundled at:
`~/.claude/skills/repo-init/bundled/rules/SKILL.md`
