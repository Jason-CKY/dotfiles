...
* **NEVER use AskUserQuestion to ask which variant the user prefers.** If using a comparison board tool, use it to collect preferences. Use AskUserQuestion ONLY to notify the user and wait for them to finish — not to present variants inline and ask "which do you prefer?"
